...
public class RewardServiceImpl implements RewardService {
    ...
    public String calculateRewardPoints(String emailId,Integer noOfMonths, LocalDate fromDate, LocalDate toDate) throws RewardPointsException {
        ...
        // Here I'm reorganizing the dates to ensure that the values are consistent and valid for the query.  
        ...
        List<RewardPoints> purchaseDetails = rewardPointsRepository.findByEmailIdAndDateOfPurchaseBetween(emailId, effectiveFrom, effectiveTo);
        ...
        for(RewardPoints rewardPoints : purchaseDetails) {
            ...
            System.out.println(rewardPoints.getSerialNumber()+" "+rewardPoints.getEmailId()+" "+rewardPoints.getName()+" "+rewardPoints.getDateOfPurchase()+" "+rewardPoints.getAmount());
        ...
        return result+"Total: "+totalRewardPoints+" points";
}
    ...
    public CompletableFuture<List<RewardPointsDTO>> getPurchaseDetails(String emailId) throws RewardPointsException {
        ...
        List<RewardPointsDTO> rewardPointsDTOs = modelMapper.map(purchaseDetails, new TypeToken<List<RewardPointsDTO>>() {}.getType());
