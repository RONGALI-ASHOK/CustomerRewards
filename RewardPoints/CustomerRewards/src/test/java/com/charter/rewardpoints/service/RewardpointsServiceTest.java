...
class RewardpointsServiceTest {
        ...
        void testValidationThrowsException() {
                ...
                rewardService.calculateRewardPoints(1, 2, LocalDate.of(2026, 1, 1), LocalDate.of(2026, 3, 1)));
        ...
        void testCalculateRewardPointsSuccess() {
                ...
                assertTrue(response.getMonthlyRewardPoints().stream()
                                ...
                                .anyMatch(m -> m.getMonth().equals("January") && m.getPoints().equals(150)));

                assertTrue(response.getMonthlyRewardPoints().stream()

                                .anyMatch(m -> m.getMonth().equals("February") && m.getPoints().equals(25)));
        ...
        void testTransactionsSpanningYearBoundaries() {
                ...
                assertTrue(response.getMonthlyRewardPoints().stream()
                                ...
                                .anyMatch(m -> m.getMonth().equals("December") && m.getYear() == 2025
                                                && m.getPoints().equals(90)));

                assertTrue(response.getMonthlyRewardPoints().stream()

                                .anyMatch(m -> m.getMonth().equals("January") && m.getYear() == 2026
                                                && m.getPoints().equals(30)));
